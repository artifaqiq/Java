...
public class Runner extends Sprite {
  ...
  /**
   * @param is start positions runner
   */
  ...
  /**
   * It calculates the position the next time
   */
  @Override
  public void update(double deltaTime) {
    ...
    if (mIsJump == true) {
      ...
      mPosY = (int) (mPosY - mSpeedY * deltaTime + mGravitation * deltaTime * deltaTime / 2);
      ...
      mSpeedY = (int) (mSpeedY - mGravitation * deltaTime * mAcerbity);
      mTimeJumpImage += deltaTime;
